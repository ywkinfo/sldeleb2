...
import type { PracticeItem, ReadingMCQItem, SpeakingTaskItem, WritingTaskItem } from "@/lib/types";

export const metadata: Metadata = { title: "DELE B2 연습", description: "B2 읽기 창작문항, 쓰기와 말하기 과제를 한국어 해설 및 자기평가와 함께 연습하세요.", alternates: { canonical: "/practice" } };
export default function PracticePage() {
  ...
  const reading = publishedItems.filter((item): item is ReadingMCQItem => item.kind === "mcq");
