...
export const metadata: Metadata = { title: "DELE B2 공식 자료", description: "Instituto Cervantes의 DELE B2 모델 시험, 오디오, 전사와 정답 자료를 빠르게 찾으세요.", alternates: { canonical: "/materials" } };
