...
export function HomeProgress() {
  ...
  const correct = reading.filter((a) => a.correct).length;
  return <div className="card flat accent" aria-label="이 기기의 학습 현황">
    ...
    <div className="grid cols-3">
      ...
      <div><strong style={{ fontSize: "1.8rem" }}>{reading.length ? Math.round(correct / reading.length * 100) : 0}%</strong><div className="muted">읽기 최근 정답률</div></div>
